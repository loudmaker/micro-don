...
public class PostResourceHandler {
    ...
    @Inject
    public PostResourceHandler(HttpExecutionContext ec) {
        this.ec = ec;
    }
/*
    ...
    public CompletionStage<PostResource> create(PostResource resource) {
        return repository.create().thenApplyAsync(savedData -> {
    ...
    public CompletionStage<Optional<PostResource>> update(String id, PostResource resource) {
        return repository.update(Long.parseLong(id)).thenApplyAsync(optionalData -> {
