...
public class HomeController extends Controller {
    ...
    private CompletionStage<Result> getAllTransaction(String email, String password, String nextUri) {
        ...
        WSRequest request = ws.url(((nextUri != null) ? nextUri : "https://sync.bankin.com/v2/transactions"))
        ...
        return request.get().thenCompose(response -> {
            ...
            if (jsonResp.has("resources")) {
                    ...
                    if (jsonResp.has("pagination")) {
                        ...
                        if (jsonNextUri != null) {
                            System.out.println("papapapapa !!!!!!!!!!!!!!!! (" + transactionList.size() + ") "+jsonNextUri);
                            try{Thread.sleep(1000);} catch (InterruptedException e) { }
                            return getAllTransaction(email, password, "https://sync.bankin.com" + jsonNextUri);
                        }
                    }
